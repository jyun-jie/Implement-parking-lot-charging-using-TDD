...
public class CalculateParkingFeeServiceTest {
    ...
    void over_150_minute_then_pay_150(){
        given_car_drives_in_at("ABC-1234","2024-01-02" + "T00:00:00");
    ...
    private static void given_car_drives_in_at(String plate, String startText) {
    ...
    void over_30_minute_then_pay_60(){
        given_car_drives_in_at("ABC-1234", "2024-01-02" + "T00:01:00");
    ...
    void partial_day_then_whole_days(){
        given_car_drives_in_at("ABC-1234", "2024-01-02" + "T23:50:00");
        given_car_drives_out_at("ABC-1234", "2024-01-04" + "T00:00:00");
    ...
    void saturday_pay_50_per_half_hour(){
        given_car_drives_in_at("ABC-1234", "2024-01-06" + "T00:00:00");
    ...
    void sunday_pay_50_per_half_hour(){
        given_car_drives_in_at("ABC-1234", "2024-01-07" + "T00:00:00");
    ...
    void national_holiday_pay_50_per_half_hour(){
        given_car_drives_in_at("ABC-1234", "2024-01-01" + "T00:00:00");
